<template>
  <div class="container" id="container">
    <div class="form-container sign-up-container">
      <!-- //partie de droite profe-->
      <form>
        <div>
          <h1 style="padding-top: 0px;">Sign In</h1>
          ...
          <v-form ref="form" v-model="valid">
            ...
            <div>
              ...
              <v-card-actions class="justify-end"
                ><v-btn style="min-width: 140px;" @click="loginSeller"
                  >Sign In</v-btn
                ></v-card-actions
              >
            </div>
        ...
        <div>
          ...
          <v-form ref="form" v-model="valid">
            ...
            <div>
              ...
              <v-card-actions class="justify-end"
                ><v-btn style="min-width: 140px;" @click="loginClient"
                  >Sign In</v-btn
                ></v-card-actions
              >
            </div>
  ...
  methods: {
    async loginSeller() {
      if (this.$refs.form.validate()) {
        ...
        try {
          await this.$store.dispatch("users/signin", payload);
          this.$snotify.success("Connected");
          setTimeout(() => {
            this.$router.push("/");
          }, 1000);
    ...
    async loginClient() {
      if (this.$refs.form.validate()) {
        ...
        try {
          await this.$store.dispatch("users/signinClient", payload);
          this.$snotify.success("Connected");
          setTimeout(() => {
            this.$router.push("/");
          }, 1000);
